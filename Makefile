...
VERSION ?= $$($(SEMVER) get release | cut -d'v' -f2)
...
# cloudmonkey.org/grafoo-bundle:$VERSION and cloudmonkey.org/grafoo-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/cldmnky/grafoo
...
release: semver
	...
	SEMVER=$$(echo $$VERSION | cut -d'v' -f2); \
	git add .; \
	git commit -m "Release $$VERSION"; \
	git push; \
	git checkout -b release/$$VERSION; \
	VERSION=$$(SEMVER) IMG=$(IMAGE_TAG_BASE):$$SEMVER $(MAKE) bundle bundle-build bundle-push; \
	git add .; \
